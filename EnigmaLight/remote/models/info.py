...
def getStatusInfo(self, controller):
	...
	statusinfo['dyna_mood'] = controller.getOptionValue("dyna_mood")
	...
	statusinfo['option_red'] = controller.getOptionValue("adjustr")
	statusinfo['option_green'] = controller.getOptionValue("adjustg")
	statusinfo['option_blue'] = controller.getOptionValue("adjustb")
	#Moodlamp
	statusinfo['option_moodlampbrightness'] = controller.getOptionValue("moodlamp_brightness")
	statusinfo['option_moodlampmode'] = controller.getOptionValue("moodlamp_mode")
	statusinfo['option_moodlamp_red'] = controller.getOptionValue("moodlamp_static_color_r")
	statusinfo['option_moodlamp_green'] = controller.getOptionValue("moodlamp_static_color_g")
	statusinfo['option_moodlamp_blue'] = controller.getOptionValue("moodlamp_static_color_b")
