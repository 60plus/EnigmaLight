...
$(function() {
	...
	$( "#slider_brightness" ).slider({
		...
		stop: function(event, ui) {	
			if (String(this.value) == Math.floor(String(this.value))) {
				var jqxhr = $.ajax( "control/option?set=brightness&v=" + String(this.value	) + ".0" );
			}else{
	...
	$( "#slider_brightnessmin" ).slider({
		...
		stop: function(event, ui) {	
			if (this.value.length == 1) {
				var jqxhr = $.ajax( "control/option?set=brightnessmin&v=" + String(this.value) + ".00" );
				
			}else if (this.value.length == 3) {
				var jqxhr = $.ajax( "control/option?set=brightnessmin&v=" + String(this.value) + "0" );
	...
	$( "#slider_brightnessmax" ).slider({
		...
		stop: function(event, ui) {	
			if (this.value.length == 1) {
				var jqxhr = $.ajax( "control/option?set=brightnessmax&v=" + String(this.value) + ".00" );
				
			}else if (this.value.length == 3) {
				var jqxhr = $.ajax( "control/option?set=brightnessmax&v=" + String(this.value) + "0" );
	...
	$( "#slider_saturation" ).slider({
		...
		stop: function(event, ui) {	
			if (String(this.value) == Math.floor(String(this.value))) {
				var jqxhr = $.ajax( "control/option?set=saturation&v=" + String(this.value) + ".0" );
			}else{
	...
	$( "#slider_saturationmin" ).slider({
		...
		stop: function(event, ui) {	
			if (this.value.length == 1) {
				var jqxhr = $.ajax( "control/option?set=saturationmin&v=" + String(this.value) + ".00" );
				
			}else if (this.value.length == 3) {
				var jqxhr = $.ajax( "control/option?set=saturationmin&v=" + String(this.value) + "0" );
	...
	$( "#slider_saturationmax" ).slider({
		...
		stop: function(event, ui) {	
			if (this.value.length == 1) {
				var jqxhr = $.ajax( "control/option?set=saturationmax&v=" + String(this.value) + ".00" );
				
			}else if (this.value.length == 3) {
				var jqxhr = $.ajax( "control/option?set=saturationmax&v=" + String(this.value) + "0" );
	...
	$( "#slider_gamma" ).slider({
		...
		stop: function(event, ui) {	
			if (String(this.value) == Math.floor(String(this.value))) {
				var jqxhr = $.ajax( "control/option?set=gamma&v=" + String(this.value) + ".0" );
			}else{
	...
	$( "#slider_adjustr" ).slider({
		...
		stop: function(event, ui) {	
			...
			var jqxhr = $.ajax( "control/option?set=adjustr&v=" + String(this.value) );
		}
	});
	
	//Adjustg slider
	$( "#slider_adjustg" ).slider({
		...
		stop: function(event, ui) {	
			...
			var jqxhr = $.ajax( "control/option?set=adjustg&v=" + String(this.value) );
		}
	});
	
	//Adjustb slider
	$( "#slider_adjustb" ).slider({
		...
		stop: function(event, ui) {	
			...
			var jqxhr = $.ajax( "control/option?set=adjustb&v=" + String(this.value) );
		}
	});
...
function getStatusInfo() {
	...
	$.getJSON('/api/statusinfo').success(function(statusinfo) {
		...
		//Set Red
        $("#slider_adjustr").val(statusinfo['option_red']).slider('refresh');
		//Set Green
        $("#slider_adjustg").val(statusinfo['option_green']).slider('refresh');
		//Set Blue
        $("#slider_adjustb").val(statusinfo['option_blue']).slider('refresh');
		//Set Moodlampmode
